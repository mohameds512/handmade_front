          ...
          <div class="flex-fill mx-1">
            <form ref="ruleForm" @submit.stop.prevent="deleteRole">
              <b-form-group :state="roleState">
                <v-select :reduce="option => option.name" multiple :state="roleState" required placeholder="Choose Role" v-model="role" :dir="$store.state.appConfig.layout.isRTL ? 'rtl' : 'ltr'" label="name" :options="roles">
